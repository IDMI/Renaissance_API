component
	output="false"
{
	public model.utilities.Utils function init()
		output="false"
	{
		return this;
	}

	public string function newLine(numeric count = 1)
		hint="returns new line feed"
		output="false"
	{
		return repeatString(chr(13) & chr(10), arguments.count);
	}

	public string function newTab(numeric count = 1)
		hint="returns new tab"
		output="false"
	{
		return repeatString(chr(9), arguments.count);
	}
